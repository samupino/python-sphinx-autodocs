...
class ClassB1:
    ...
    def sample_mathod(self):
        """sample_method docstring summary.

        Pellentesque ut consectetur lectus. Phasellus vehicula non ante
        vel molestie. Suspendisse potenti.
        """
        pass


class ClassB2:
    """ClassB2 docstring summary.
    ...
    def another_method(self):
        """another_method docstring summary.
